...
<head>
  ...
  <title>404 — <?= htmlspecialchars($storeName) ?></title>
...
<div style="min-height:100vh;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:2rem;text-align:center;background:var(--background)">
  ...
  <h1 style="font-size:2rem;color:var(--text-primary);margin-bottom:0.5rem">Page Not Found</h1>
  <p style="color:var(--text-secondary);margin-bottom:1.5rem;max-width:400px">The page you're looking for doesn't exist or has been moved.</p>
